...
<head>
    ...
    <!-- Tailwind (scoped to course_create.php only: prefix + preflight off so it never touches Bootstrap-based partials) -->
            ...
            <div class="tw-sticky tw-top-0 tw-z-20 tw-bg-white tw-border-b tw-border-slate-200 tw-shadow-sm">
                <div class="tw-w-full tw-px-4 lg:tw-px-8 tw-py-3 tw-flex tw-items-center tw-justify-between tw-gap-3">
                    <div class="tw-flex tw-items-center tw-gap-2 tw-min-w-0">
                        ...
                        <div id="title_edit" class="tw-text-lg md:tw-text-xl tw-font-bold tw-text-brandink tw-truncate"><?= $lang['createcourse'] ?></div>
                    </div>
                    <div class="tw-flex tw-items-center tw-gap-2 tw-shrink-0">
                        <button type="button" onclick="create_course()" class="tw-inline-flex tw-items-center tw-gap-1 tw-bg-brand hover:tw-opacity-90 tw-text-white tw-border-0 tw-rounded-lg tw-px-4 tw-py-2 tw-text-sm tw-font-medium">
                            <i class="bi bi-check-lg"></i> <span class="tw-hidden sm:tw-inline"><?= $lang['create'] ?></span>
                        </button>
                ...
                <form id="form-course" class="tw-grid tw-grid-cols-1 lg:tw-grid-cols-12 tw-gap-4">
                    ...
                    <section class="lg:tw-col-span-3 tw-flex tw-flex-col tw-gap-4">
                        <div class="tw-bg-white tw-rounded-xl tw-shadow tw-p-5">
                            ...
                            <select class="form-select tw-mb-3" name="select_faculty" id="select_faculty"></select>
