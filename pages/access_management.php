    ...
    <div class="main-inner d-flex">
        <div class="bg-light d-flex" style="width: 100%;">
            ...
            <div class="d-flex flex-column justify-content-center w-100">
                <h2 class="p-4 text-center" style="max-width: 100%">AMS - <?=$lang['ams']?>.</h2>
                <div class="px-4 d-flex flex-wrap justify-content-center  gap-3 ">
                    ...
                    <button class="btn btn-primary col-12 col-lg-2" style="max-width: 150px;" onclick="accessall()"><?=$lang['access']?><?=$lang['all']?></button>
                </div>
