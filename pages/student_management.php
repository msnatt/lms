...
<head>
    <meta charset="UTF-8">
    <title><?= $lang['sms'] ?> - E-learning</title>

    <!-- Tailwind (scoped to student_management.php only: prefix + preflight off so it never touches Bootstrap-based partials) -->
    ...
    <style>
        ...
        .sms-panel .form-control:focus,
        .sms-panel .form-select:focus,
        .sms-modal .form-control:focus,
        .sms-modal .form-select:focus {
            border-color: #0284c7;
...
<body style="background-color: <?= $bg; ?>">
            ...
            <div class="tw-max-w-6xl tw-mx-auto tw-px-4 tw-py-8">
                ...
                <div class="tw-mb-6">
                    <h2 class="tw-flex tw-items-center tw-gap-2 tw-text-xl md:tw-text-2xl tw-font-bold tw-m-0 tw-text-brandink">
                        <i class="bi bi-person-check-fill tw-text-brand"></i><?= $lang['sms'] ?>
                    </h2>
                </div>
                ...
                <div class="tw-flex tw-flex-col tw-gap-4">
                    ...
                    <!-- Filter -->
                    <div class="tw-bg-white tw-rounded-xl tw-shadow tw-p-4 sms-panel">
                    ...
                    <div id="student_list" class="tw-bg-white tw-rounded-xl tw-shadow tw-overflow-hidden">
                        <div id="table-wrap" class="tw-max-h-[55vh] tw-overflow-y-auto">
                            <table id="table_list_student" class="sms-table">
                                <thead>
                                    <tr>
                                        <th style="width: 44px;">
                    ...
                    <div class="tw-flex tw-justify-end tw-gap-2">
                        <button type="button" id="btn-remove"
                            ...
                            disabled>
                            <i class="bi bi-person-dash tw-mr-1"></i><?= $lang['unenroll'] ?> (<span id="remove-count">0</span>)
                        </button>
                        <button type="button" id="btn-add"
                            ...
                            disabled>
                            <i class="bi bi-person-plus tw-mr-1"></i><?= $lang['registerc'] ?> (<span id="add-count">0</span>)
                        </button>
                    </div>
    ...
    <!-- Confirm modal -->
    <div class="modal fade sms-modal" id="confirmModal" tabindex="-1" aria-labelledby="confirmModalLabel" aria-hidden="true">
