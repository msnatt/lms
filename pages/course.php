...
<head>
    ...
    <!-- Tailwind (scoped to course.php only: prefix + preflight off so it never touches Bootstrap-based partials) -->
        ...
        <div id="main-content" class="flex-grow-1" style="transition: all 0.3s ease;">
            <div class="tw-max-w-6xl tw-mx-auto tw-px-4 tw-py-8">
                ...
                <div class="tw-flex tw-justify-between tw-items-center tw-mb-6">
                    <h2 class="tw-text-xl md:tw-text-2xl tw-font-bold tw-m-0"><?= $lang['allcourse'] ?></h2>
                </div>

                <div class="tw-flex tw-flex-col lg:tw-flex-row tw-gap-6">

                    <!-- Filter sidebar -->
                    <div class="lg:tw-w-72 tw-shrink-0">
                        <details class="tw-bg-white tw-rounded-xl tw-shadow lg:tw-sticky lg:tw-top-4" open id="filter-box">
                            ...
                            <div class="tw-px-4 tw-pb-4 tw-flex tw-flex-col tw-gap-3">
                                ...
                                <button type="button" onclick="clearFilters()" class="tw-w-full tw-bg-slate-100 tw-text-slate-600 tw-rounded-lg tw-py-2 tw-font-medium tw-border-0 hover:tw-bg-slate-200">
                    ...
                    <!-- Results -->
                    <div id="result-box" class="tw-flex-1 tw-min-w-0">
                        ...
                        <div id="course_div" class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 xl:tw-grid-cols-3 tw-gap-6" style="min-height: 40svh;"></div>
