...
$lang = [
    ...
    "scorebycourse" => "Average score by course",
    "score" => "Score",
    "percent" => "Percent",
    "exam" => "Exam",
    "examdate" => "Date",
    "searchresult" => "Search course / exam",
    "sortby" => "Sort by",
    "newest" => "Newest",
    "highscore" => "Score high → low",
    "lowscore" => "Score low → high",
    "bycoursename" => "Course name (A-Z)",
    "allcourses" => "All courses",
    "print" => "Print",
    "downloadpdf" => "Download PDF",
    "noresult" => "No results yet",
    "noexamyet" => "No exam results for this course",
    "avglabel" => "Avg",
    "examdonecount" => "Completed",
    "items" => "items",
